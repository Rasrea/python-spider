...
def main():
    for gap in range(0, total_progress + 1, 20):
        ...
        sys.stdout.write(f'\rProgress: {gap}/{total_progress} {progress_bar}')
        sys.stdout.flush()
